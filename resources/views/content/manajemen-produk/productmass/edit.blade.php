                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-wrapper"
                        ...
                        <div class="table-title">
                            <div class="row">
                                ...
                                <a href="{{ url()->previous() }}" class="btn btn-outline-light" style="border-radius: 10px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select name="brand_id" id="brand" class="form-select"
                                        ...
                                        <option>Select Brand</option>
                                            <option selected value="{{ $product->brand->name }}">{{ $product->brand->name }}</option>
                                    </select>
                                </div>
                                <div class="col-sm-6 mb-3">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select name="preorder_category_id" id="preorder_category" class="form-select"
                                        ...
                                        <option selected>{{ $product->preorder->name }}</option>
                    ...
                    <div class="table-wrapper"
                        ...
                        <div class="card p-4">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <img src="{{ $product->avatar }}"  class="img-fluid rounded mx-auto d-block " id="img-preview" style="max-height: 200px;">
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select"
                                        aria-label="Default select example">
                                        <option {{ $product->iud_status == 'i' ? 'selected' : '' }} value="1">Ya</option>
                                        <option {{ $product->iud_status == 'd' ? 'selected' : '' }} value="0">Tidak</option>
                                    </select>
                                </div>
                                <div class="col-sm-12">
