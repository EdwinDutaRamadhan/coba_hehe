        ...
        <li class="dropdown "><!-- MANAJEMEN PRODUK -->
            ...
            <ul class="collapse {{ Request::segment(2) == 'manajemen-produk' ? 'show' : '' }}" id="manajemen_produk">
                <li class="{{ Request::segment(3) == 'kategori-produk' ? 'active' : '' }}">
                    <a href="{{ route('manajemen-produk.kategori-produk.index') }}"><i class="material-icons ps-4">category</i>
                ...
                <li class="{{ Request::segment(3) == 'brand' ? 'active' : '' }}">
                    <a href="{{ route('manajemen-produk.brand.index') }}"><i class="material-icons ps-4">corporate_fare</i>
                        <span>Brand</span></a>
                </li>
                ...
                <li class="{{ Request::segment(3) == 'productmass' ? 'active' : '' }}">
                    <a href="{{ route('manajemen-produk.productmass.index') }}"><i class="material-icons ps-4">local_mall</i>
                        <span>Produkmass</span></a>
                </li>

                <li class="{{ Request::segment(3) == 'kategori-preorder' ? 'active' : '' }}">
                    <a href="{{ route('manajemen-produk.kategori-preorder.index') }}"><i class="material-icons ps-4">add_shopping_cart</i>
                        <span>Kategori Preorder</span></a>
                </li>

                <li class="{{ Request::segment(3) == 'merk' ? 'active' : '' }}">
                    <a href="{{ route('manajemen-produk.merk.index') }}"><i class="material-icons ps-4">shopping_bag</i>
                        <span>Merk</span></a>
                </li>
            </ul>
        </li>
