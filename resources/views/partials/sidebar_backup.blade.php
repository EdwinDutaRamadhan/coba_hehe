...
<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="dropdown"><!-- MANAJEMEN USER -->
            ...
            <ul class="collapse {{ Request::is('admin/admin-panel/*') ? 'show' : '' }}" id="admin_panel">
                <li class="{{ Request::is('admin/admin-panel/data') ? 'active' : '' }}">
                    <a href=""><i class="material-icons ps-4">folder_shared</i>
                        <span>Admin</span></a>
                </li>

                <li class="{{ Request::is('admin/admin-panel/akses') ? 'active' : '' }}">
                    <a href=""><i class="material-icons ps-4">admin_panel_settings</i>
